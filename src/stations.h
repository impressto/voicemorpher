...
static const RadioStation STATIONS[] = {
  ...
  {"80s Country",       "http://listen.181fm.com/181-80scountry_128k.mp3"},     // 128kbps
...
static const char *STATION_NAMES[] = {
  "NPR News", "Classical Relax", "KEXP Seattle", "Jazz Groove",
  "Old School Hip-Hop", "80s Country", "NPO Radio 1", "Chocolate FM",
};
